...
Note*: elevator_part2.txt is the file that is sporadic in its results. While using it as input, our code produces results where all riders complete their trips to only some riders completing their trips.
